          ...
          <div className="md:w-3/6 mt-8">
            <form onSubmit={(e) => handleSearch(e)}>
              <div className="form-group relative">
                <input
                  type="text"
                  className="h-12 w-full px-[4rem] py-2 border border-slate-200 shadow-sm focus:border-2 focus:border-slate-400 focus:outline-none"
              ...
              <button className="text-xs font-semibold px-12 py-2 bg-slate-100 border border-slate-300 rounded-md text-blue-600 mt-7 hover:bg-blue-300">
                Search
              </button>
            </form>
          </div>
